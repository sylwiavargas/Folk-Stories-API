class Api::V1::MonthDaysController < ApplicationController
    ...
    def show
      ...
      @events = @monthday.events.map{|e| {event: {id: e.id, title_eng: e.title_eng, description_eng: e.description_eng, month_id: e.month_id, day_id: e.day_id, year_era_id: e.year_era_id, read_more_eng: e.read_more_eng, types: e.types, people: e.people}}}
